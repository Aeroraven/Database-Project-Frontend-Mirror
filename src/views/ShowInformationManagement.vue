<template>
    <div class="zms-anishowinfo">
        <span class="zms-anishowinfo-title zms-primary-color" color="primary">
...
export default {
    ...
    created(){
        this.$store.dispatch('alterTopNavTitle',{title:this.$store.state.sPageName.animalShowInfoManagement})
    },
    components:{
