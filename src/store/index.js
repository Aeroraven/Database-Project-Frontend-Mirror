  ...
  state: {
    ...
    sProjectFunctions:[
      {name:'动物管理',route:'',icon:'assets/slide-bar-animal-manage.png',child:[
        ...
        {name:'食谱管理',route:'',icon:'assets/slide-bar-animal-manage.png',child:[]},
        {name:'喂养管理',route:'',icon:'assets/slide-bar-animal-manage.png',child:[]},
        {name:'繁育管理',route:'',icon:'assets/slide-bar-animal-manage.png',child:[]},
      ]},
