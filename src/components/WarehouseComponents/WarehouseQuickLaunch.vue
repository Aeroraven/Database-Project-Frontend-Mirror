                ...
                <v-container fluid class="fill-height justify-center">
                    <v-row align="center" class="mx-0">
                        <v-col cols="12" md="3" class="align-self-stretch">
                            <homepage-quick-launch-button icon="mdi-database-edit" title="进出仓管理" info="记录物品出仓与入库"
                            zmsroute='/warehouseManagement/flowManagement'/>
                        </v-col>
                        <v-col cols="12" md="3" class="align-self-stretch">
                            <homepage-quick-launch-button icon="mdi-warehouse" title="仓库信息" info="查看所有仓库的信息"
                            zmsroute='/warehouseManagement/infoManagement'/>
                        </v-col>
                        <v-col cols="12" md="3" class="align-self-stretch">
                            <homepage-quick-launch-button icon="mdi-cube" title="货物管理" info="查看当前所有物品"
                            zmsroute='/warehouseManagement/itemManagement' />
                        </v-col>
                        <v-col cols="12" md="3" class="align-self-stretch">
                            <homepage-quick-launch-button icon="mdi-cart" title="采购管理" info="处理采购信息"
