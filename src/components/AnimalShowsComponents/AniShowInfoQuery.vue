            ...
            <div>
                <v-container>
                    <v-row>
                        ...
                        <v-col cols="12" sm="6" md="3">
                            <v-text-field label="演出名称" placeholder="请输入演出名称" prepend-icon="el-icon-view"  />
                        </v-col>
                        <v-col cols="12" sm="6" md="3">
                            <v-text-field label="演出动物编号" placeholder="请输入演出动物编号" prepend-icon="el-icon-link"  />
                        </v-col>
                        <v-col cols="12" sm="6" md="3">
