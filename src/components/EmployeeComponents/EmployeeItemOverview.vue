    ...
    > -->
                    <v-row>
                        <!-- <v-col cols="12" sm="6" md="3">
                            <v-text-field label="员工工号" placeholder="请输入工号" prepend-icon="el-icon-s-custom"  />
                        </v-col> -->
                        <!-- <v-col cols="12" sm="6" md="3">
                            <v-text-field label="员工姓名" placeholder="请输入员工姓名" prepend-icon="el-icon-document-copy"  />
                        </v-col>
                        <v-col cols="12" sm="6" md="3">
                            <v-text-field label="所属园区" placeholder="请输入员工所属园区" prepend-icon="el-icon-coordinate"  />
                        </v-col>
                        <v-col cols="12" sm="6" md="3">
        ...
        <v-dialog v-model="deleteDialog" persistent width="600" >
            <v-card color="" :ripple="{class:null}" >
                <v-card-title class=" zms-strip-bg text-h5 text--white orange darken-3 " color="warning">
                    <v-icon color="white">mdi-close-thick</v-icon>&nbsp;<span class="text--white" style="color:#ffffff !important;">{{$t('employee.item.delete')}}</span>
                </v-card-title>
                <v-divider/>
                <br/>
                <v-card-text>
                    <span class="zms-poptip-body">{{$t('employee.item.delete_content')}}</span><br/><br/>
                </v-card-text>
                <v-divider/>
                <v-card-actions>
                    <v-spacer></v-spacer>
