<template>
            ...
            <v-row>
                <v-col cols="12" md="4" v-for="item in employeeInfoDetail" :key="item.id" class="align-self-stretch">
                    <v-card  :class="cardNightClass" :ripple="{ class: null }" class="mx-auto" max-width="400">
                        ...
                        <v-card-actions>
                            <v-btn color="primary" text @click="gotoItem(item.sid)">查看员工信息</v-btn>
                            <v-btn color="primary" text @click="openDialog(item.sid)">编辑该员工信息</v-btn>
                        </v-card-actions>
                    </v-card>
            ...
            <v-card :ripple="{class:null}">
                ...
                <v-card-text>
                    <v-container>
                        <v-row>
                            <v-col cols="12" lg="12">
                                <v-text-field v-model="alterItem.id" :label="$t('employee.Info.wareid')"></v-text-field>
                            </v-col>
                            <v-col cols="12" lg="12">
 ...
 <v-col cols="12" sm="6" md="4">
                                                <v-text-field v-model="editedItem['password']" :label="$t('employee.item.password')"></v-text-field>
                                            </v-col>
...
<script>
import {getEmployeeItemInfo, updateEmployeeItemInfo} from '../../apis/employee.js'
export default {
    components: {  },
    name: 'employeeInfo',
    props:{
