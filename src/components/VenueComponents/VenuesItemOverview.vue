    ...
    <div class="zms-anicare" :class="nmNightClass">
                ...
                <v-container>
                    ...
                    <v-row>
                        ...
                        <v-col cols="12" sm="6" md="3">
                         ...
                         -->
                          <v-col cols="12" sm="6" md="3">
                                                <v-text-field v-model="editedItem['id']" :label="$t('venue.item.id')" placeholder="请输入场馆编号" prepend-icon="mdi-music-accidental-sharp"></v-text-field>
                                            </v-col>
                                            <v-col cols="12" sm="6" md="3">
                                                <v-text-field v-model="editedItem['name']" :label="$t('venue.item.name')" placeholder="请输入场馆名称" prepend-icon="mdi-tag" ></v-text-field>
                                            </v-col>
                        
                                             <v-col cols="12" sm="6" md="3">
                                                <v-text-field v-model="editedItem['location']" :label="$t('venue.item.location')" placeholder="请输入场馆位置" prepend-icon="mdi-form-textbox"></v-text-field>
                                            </v-col>
                                            <!-- <v-col cols="12" sm="6" md="3">
      ...
      >
        <v-select
          ...
          v-model="editedItem['status']" :label="$t('venue.item.status')" placeholder="请输入场馆开放状态" prepend-icon="mdi-account-key"
        ></v-select>
      </v-col>
                    </v-row>
                                    ...
                                    <v-card-text>
                                        <v-container>
                                            ...
                                            <v-col cols="12" sm="6" md="4">
                                                <v-text-field v-model="editedItem['id']" :label="$t('venue.item.id')"></v-text-field>
                                            </v-col>
                                            <v-col cols="12" sm="6" md="4">
