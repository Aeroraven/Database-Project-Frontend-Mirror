<template>
  <div class="zms-home-notice">
        ...
        <v-container>
            <v-row>
                <v-col cols="12" md="4" v-for="item in venueDetail" :key="item.alterItem_id" class="align-self-stretch">
                    <v-card  :class="cardNightClass" :ripple="{ class: null }" class="mx-auto" max-width="400">
                        <v-img class="white--text align-end" height="200px" src="https://upload.wikimedia.org/wikipedia/commons/3/30/Giants_of_the_Savanna.jpg">
                            <v-card-title>{{item.alterItem_name}}</v-card-title>
                        </v-img>
                        <v-card-subtitle class="pb-0"><b>场馆编号</b> {{item.alterItem_id}}</v-card-subtitle>
                        <v-card-text class="text--primary pb-0">
                            <div><b>位置</b></div>
                            <div>{{item.alterItem_location}}</div>
                        </v-card-text>
            ...
            <v-card :ripple="{class:null}" >
                ...
                <v-card-text>
                    <v-container fluid>
                        <v-row>
                            <!-- <v-col cols="12" lg="12">
                                <v-text-field v-model="alterItem_id" disabled :label="$t('venue.Info.wareid')"></v-text-field>
                            </v-col>
                            <v-col cols="12" lg="12">
                                <v-text-field v-model="alterItem_storage_name"  :label="$t('venue.Info.wareName')"></v-text-field>
                            </v-col>
                            <v-col cols="12" lg="12">
      ...
      >
        ...
        <v-dialog persistent v-model="submitStat" width="300">
            <v-card >
                <v-card-title>{{$t('venue.Submitting')}}</v-card-title>
                <v-divider/>
                <br/>
                <v-card-text>
                    {{$t('venue.PleaseWait')}}<br/><br/>
                    <v-progress-linear indeterminate striped color="primary" class="mb-0"></v-progress-linear>
                </v-card-text>
            </v-card>
        </v-dialog>
