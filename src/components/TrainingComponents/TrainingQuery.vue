                ...
                <v-container>
                    <v-row>
                        <v-col cols="12" sm="6" md="3">
                            <v-text-field label="训练编号" placeholder="请输入训练编号" prepend-icon="mdi-music-accidental-sharp"  />
                        </v-col>
                        <v-col cols="12" sm="6" md="3">
                            <v-text-field label="训练名称" placeholder="请输入训练名称" prepend-icon="el-icon-view"  />
                        </v-col>
                        <v-col cols="12" sm="6" md="3">
                            <v-text-field label="训练动物编号" placeholder="请输入训练动物编号" prepend-icon="el-icon-link"  />
                        </v-col>
                        <v-col cols="12" sm="6" md="3">
                            <v-text-field label="负责人名称" placeholder="请输入负责人名称" prepend-icon="el-icon-s-custom"  />
                        </v-col>
                        <v-col cols="12" sm="6" md="3">
                            <v-text-field label="训练地点" placeholder="请输入训练地点" prepend-icon="el-icon-position"  />
                        </v-col>
                        <v-col cols="12" sm="6" md="3">
...
export default {
    ...
    created(){
        ...
        headers:[
            {text: '训练编号', value: 'show_id'},
            {text: '训练名称', value: 'show_name'},
            {text: '训练动物数量', value: 'amount'},
            {text: '训练动物编号', value: 'animal_id'},
            {text: '负责人姓名', value: 'principal_name'},
            {text: '训练场地', value: 'show_site'},
            {text: '训练时间', value: 'show_time'},
            {text: '训练道具', value: 'show_props'},
